...
const navItems = [
  ...
  { name: 'Hero Images', path: '/admin/hero', icon: Image },
  { name: 'Messages', path: '/admin/messages', icon: MessageSquare },
  { name: 'Export History', path: '/admin/exports', icon: FileSpreadsheet },
];
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center px-4 lg:hidden">
          ...
          <span className="ml-4 font-serif text-lg text-charcoal">Admin Panel</span>
        </header>
